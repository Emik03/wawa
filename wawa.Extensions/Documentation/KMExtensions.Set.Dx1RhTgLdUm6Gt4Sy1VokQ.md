...
`audio` [T](KMExtensions.Set.Dx1RhTgLdUm6Gt4Sy1VokQ.md#Wawa.Extensions.KMExtensions.Set_T_(thisT,System.Action_int_).T 'Wawa.Extensions.KMExtensions.Set<T>(this T, System.Action<int>).T')
...
#### Returns
[T](KMExtensions.Set.Dx1RhTgLdUm6Gt4Sy1VokQ.md#Wawa.Extensions.KMExtensions.Set_T_(thisT,System.Action_int_).T 'Wawa.Extensions.KMExtensions.Set<T>(this T, System.Action<int>).T')  
The parameter [audio](KMExtensions.Set.Dx1RhTgLdUm6Gt4Sy1VokQ.md#Wawa.Extensions.KMExtensions.Set_T_(thisT,System.Action_int_).audio 'Wawa.Extensions.KMExtensions.Set<T>(this T, System.Action<int>).audio').