...
public static class HighlightedCore
{
    ...
    public static ReadOnlyCollection<Maybe<Entity>> ToEntities(
        ...
        highlighters is null ? Lot<Maybe<Entity>>.Empty : new([..highlighters.Select(ToEntity)]);
    ...
    public static ReadOnlyCollection<Highlighted> ToHighlighters(
        ...
        highlightables is null ? Lot<Highlighted>.Empty : new([..highlightables.Select(AsHighlighter)]);
}
