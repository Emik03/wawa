...
public static class HighlightedCore
{
    ...
    public static ReadOnlyCollection<Maybe<Entity>> ToEntities(
        ...
        highlighters is null ? Chest<Maybe<Entity>>.Empty : new(highlighters.Select(ToEntity).ToList());
    ...
    public static ReadOnlyCollection<Highlighted> ToHighlighters(
        ...
        highlightables is null ? Chest<Highlighted>.Empty : new(highlightables.Select(AsHighlighter).ToList());
}
